#Plot time-dependent ROC curve with survivalROC based on GEO dataset
...
if(T){
  ...
  if(T){
    ...
    print(p_roc)
    save(p_roc, file = file.path(Rdata_dir,'step50_LASSOmodele_p_roc_GEO.Rdata'))
    ggsave(filename = file.path(Figure_dir,'step50_LASSOmodele_ROC_GEO_4.5-4.8cm.pdf'),
